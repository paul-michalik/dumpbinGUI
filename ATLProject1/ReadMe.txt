========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLProject1 Project Overview
========================================================================

AppWizard has created this ATLProject1 project for you to use as the starting point for
...
ATLProject1.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLProject1.h)
        GUID definitions                                (ATLProject1_i.c)
        A type library                                  (ATLProject1.tlb)
        Marshaling code                                 (ATLProject1_p.c and dlldata.c)

ATLProject1.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLProject1.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLProject1.pch and a precompiled types file named StdAfx.obj.
...
ATLProject1ps.vcxproj
	...
	dlldata.c, ATLProject1_i.c and ATLProject1_p.c which are required
