========================================================================
    ACTIVE TEMPLATE LIBRARY : dumpbinCMH Project Overview
========================================================================

AppWizard has created this dumpbinCMH project for you to use as the starting point for
...
_dumpbinCMH.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_dumpbinCMH.h)
        GUID definitions                                (_dumpbinCMH_i.c)
        A type library                                  (_dumpbinCMH.tlb)
        Marshaling code                                 (_dumpbinCMH_p.c and dlldata.c)
dumpbinCMH.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named dumpbinCMH.pch and a precompiled types file named StdAfx.obj.
...
dumpbinCMHps.vcproj
	...
	dlldata.c, dumpbinCMH_i.c and dumpbinCMH_p.c which are required
